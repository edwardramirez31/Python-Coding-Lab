...
import numpy as np
import sympy as sp
## unidades en metros cables
longitud_cables = 1.5
## diámetro en pulgadas de los cables
diámetro_cables = 1 / 4
## área en milímetros de los cables
área_cables = np.pi * (diámetro_cables * 25.4 / 1000) ** 2 / 4
## diámetro en pulgadas en pasadores
diámetro_pasadores = 1 / 2
## área en milímetros en pasadores
...
## con el equilibro de momentos calculamos BD
...
Ay_respecto_W
print("Reacción Ay respecto a W:", Ay_respecto_W)
...
Ax_respecto_W
print("Reacción Ax respecto a W:", Ax_respecto_W)
...
F_apoyo_B
print("Fuerza en el apoyo B:", F_apoyo_B)
...
## Fuerza en kN y deformación en mm
