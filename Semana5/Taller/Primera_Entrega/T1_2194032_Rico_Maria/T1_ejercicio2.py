...
# Código 2194032
# Debido a que el quinto digito es cero, se tomará el valor de 4 para L.
...
print("El ángulo AB es:",AB,",","El aumento de distancia es de:" ,aumento_distancia)
...
for distancia_AB, ax in zip(variación_distancia, np.arange(axes).flatten()):
    ...
    ax.set_title(f"Las coordenadas por el aumento de posición son de :", round(distancia_AB - 2, 3))
ax.set_xlabel("La posición del nodo B en x es:")
plt.tight_layout()
plt.show
